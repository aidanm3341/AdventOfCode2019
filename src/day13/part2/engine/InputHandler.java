...
public class InputHandler implements KeyListener {
    ...
    private void toggle(KeyEvent ke, boolean pressed) {
        if (ke.getKeyCode() == KeyEvent.VK_W) jump.toggle(pressed);
        ...
        if (ke.getKeyCode() == KeyEvent.VK_UP) jump.toggle(pressed);
        ...
        //if (ke.getKeyCode() == KeyEvent.VK_SPACE) jump.toggle(pressed);
